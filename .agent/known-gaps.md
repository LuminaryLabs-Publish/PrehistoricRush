...
6. DinoPoseFrame, CameraFrameRequest, HudFrameRequest, ContactResultSnapshot, SceneDispatchResult, RenderReadback, and PresentationFrameRecord are documented but not implemented.
