...
assert.equal(PREHISTORIC_TREE_GROWTH_REVISION, "natural-growth-v5-efficient-crossed-geometry");
...
assert.match(lushLayerSource, /createPrehistoricFoliageCardGeometry/);
assert.match(lushLayerSource, /directInstanceWrites: true/);
...
assert.match(groundLayerSource, /receiveShadow = false/);
assert.match(groundLayerSource, /v3-lit/);
