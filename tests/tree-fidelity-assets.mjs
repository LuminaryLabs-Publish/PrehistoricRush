...
const productionLayerSource = readFileSync(new URL("../src/render/three-production-forest-layer.js", import.meta.url), "utf8");
...
assert.match(groundLayerSource, /radial-frond/);
assert.match(productionLayerSource, /productionRecipe/);
assert.match(productionLayerSource, /primary:/);
assert.match(productionLayerSource, /secondary:/);
assert.match(productionLayerSource, /verticalGrain/);
assert.match(productionLayerSource, /GRASS_VARIANT_COUNT = 6/);
assert.match(productionLayerSource, /production-ground-detail/);
...
assert.match(generatorSource, /production-patches-v1/);
...
assert.match(runtimeSource, /prehistoric-patch-v7-production-forest/);
...
assert.match(adapterSource, /createThreeProductionForestLayer/);
...
console.log("tree fidelity, production vegetation, ground cover, Object Vegetation, startup, and renderer contracts passed");
